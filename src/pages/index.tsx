  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to The Tribal Box - Your platform for skill sharing and earning. Manage your profile, book skilled individuals, track usage, and assess performance, all in one place."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1546410531-bb4caa6b424d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxza2lsbHN8ZW58MHx8fHwxNjk0MTcxNTczfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to The Tribal Box - Your platform for skill sharing and earning. Manage your profile, book skilled individuals, track usage, and assess performance, all in one place.`}
            </Text>
            <Box
