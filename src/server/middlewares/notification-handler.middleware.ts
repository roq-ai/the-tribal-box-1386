...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'user.update': {
    ...
    key: 'skill-provider-profile-update',
    tenantPath: ['platform', 'user'],
    userPath: [],
  },
  'reservation.create': {
    roles: ['platform-owner', 'administrator', 'skill-provider'],
    key: 'new-reservation',
    tenantPath: ['platform', 'user', 'reservation'],
    userPath: [],
  },
  'skill.update': {
    roles: ['platform-owner', 'administrator'],
    key: 'skill-update',
    tenantPath: ['platform', 'user', 'skill'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['platform-owner', 'skill-provider', 'administrator'];
